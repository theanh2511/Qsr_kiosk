...
$(function() {
    ...
    $('.panel [data-action=collapse]').parents('.panel-heading').css('cursor','pointer');
    // Collapse on click
    $('.panel [data-action=collapse]').parents('.panel-heading').click(function (e) {
        e.preventDefault();
        var $panelCollapse = $(this).nextAll();
        $(this).find('[data-action=collapse]').parents('.panel').toggleClass('panel-collapsed');
            ...
            success: function (res) {
                switch(res.status){
                    case 200:
                        ...
                        $('body').toggleClass('sidebar-fixed-expanded-click');
                        $('.navbar-menu').toggleClass('expand-menu');
                        break;
                    case 201:
                        alert('lỗi hệ thống');
                        break;
    ...
    $(window).on('resize', function() {
        setTimeout(function() {
            ...
            if($(window).width() <= 769) {
                ...
                if($('#button_area_mobile').find('ul li').length<=2){
                    $('#button_area_mobile').html($('#button_area').html());
                }
                $('.show-menu').find('ul li:not(".hide-item-menu") a').hide();
            }
            else {
                ...
                $('.hide-menu').collapse('hide');
                $('.show-menu').find('ul li:not(".hide-item-menu") a').show();
                if($('#button_area_mobile').find('ul li').length!=0){
                    $('#button_area_mobile').html('');
                }
