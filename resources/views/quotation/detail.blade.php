...
@section('title')
    {{ trans('master_quotation.screen-title-detail') }}
@endsection

@section('content_header')
    <span class="text-header">{{ trans('master_quotation.screen-title-detail') }}</span>
            ...
            <div class="panel-body">
                <div class="col-md-9">
                    <div class="form-group">
                        <label class="col-md-2 col-sm-2 col-xs-12 control-label">{{ trans('master_quotation.DocNo') }}</label>
                        <div class="col-md-4 col-sm-4 col-xs-12">
                            <input type="text" value="{{$details->DocNo??''}}" class=" form-control required"
                                   placeholder="" data-field="DocNo">
                        </div>
                        <label class="col-md-2 col-sm-2 col-xs-12 control-label">{{ trans('master_quotation.DocDate') }}</label>
                        <div class="col-md-4 col-sm-4 col-xs-12">
                    ...
                    <div class="form-group">
                        <label class="col-md-2 col-sm-2 col-xs-12 control-label">{{ trans('master_quotation.EffectiveDate_Fr') }}</label>
                    ...
                    <div class="form-group">
                        <label class="col-md-2 col-sm-2 col-xs-12 control-label">{{ trans('master_quotation.Description') }}</label>
                ...
                <div class="col-md-9 col-sm-12 col-xs-12 class-detail">
                    <ul class="nav nav-tabs">
                        <li class="active">
                            <a data-toggle="tab" href="">{{ trans('master_quotation.tab-quot-detail') }}</a>
                        </li>
                    </ul>
                    <div class="form-group">
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover table-striped" id="tbl-detail">
                                ...
                                <tr class="col-table-header text-center">
                                    ...
                                    <th class="text-center" width="20%">{{ trans('master_quotation.ProductCode') }}</th>
                                    <th class="text-center">{{ trans('master_quotation.ProductName') }}</th>
                                    <th class="text-center" width="10%">{{ trans('master_quotation.ProductUnit') }}</th>
                                    <th class="text-center" width="20%">{{ trans('master_quotation.UnitPrice') }}</th>
                                </tr>
                                </thead>
                                <tbody>
                                    ...
                                    <tr class="">
                                        ...
                                        <td class="text-center" width="20%">
                                            <div class="input-group">
                                                <input type="text" class="form-control required product-code search-input"
                                        ...
                                        <td class="text-center" width="20%">
                                            <input value="" type="text" id="unit_price"
                                ...
                                @else
                                    @foreach($bizdoc_detail as $biz)
                                        <tr class="">
                                            ...
                                            <td class="text-center">
                                                <input type="text" class="form-control product-name" value="{{$biz->ProductName}}" disabled/>
                                            </td>
                                            <td class="text-center" width="10%">
                                                <input type="text" class="form-control product-unit" value="{{$biz->Unit}}" disabled/>
                                            </td>
                                            <td class="text-center" width="20%">
                                                <input value="{{formatNumber($biz->UnitPrice??'0')}}" type="text"
                                                       id="unit_price"
                                                       class="form-control numeric money product-unitprice"
                                                       maxlength="15"
                                                       real_len="12" decimal_len="0">
                                            </td>
                                        </tr>
                                    @endforeach
                                @endif
...
@section('content_hidden')
    ...
    <input type="hidden" id="BizType" data-field="BizType" value="QT">
@stop

@section('css')
    {!! public_url('module/master/css/quotation.detail.css') !!}
@stop

@section('js')
    {!! public_url('module/master/js/quotation.detail.js') !!}
@stop